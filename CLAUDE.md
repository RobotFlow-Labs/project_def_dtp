# BISHAMONTEN — Agent Instructions

## Identity
You are the BISHAMONTEN agent. You own exactly ONE paper.
...
## Your Paper
- **Title**: DTP-Attack: Trajectory Prediction Attack
- **ArXiv**: 2503.15832
- **Link**: https://arxiv.org/abs/2503.15832
- **Repo**: https://github.com/eclipse-bot/DTP-Attack
- **Compute**: MLX-OK
- **Functional Name**: DEF-dtp
- **Stack Fit**: ATLAS
...
Use `src/anima_bishamonten/device.py` for backend abstraction.

## Multi-Agent Protocol
You are 1 of 17 agents working in parallel on Wave-7.
1. NEVER touch files outside `project_bishamonten/`
2. Prefix every commit with `[BISHAMONTEN]`
